...
class FishingPuzzleConsoleViewsMixin:
    ...
    def _build_puzzle_view(self, _parent):
        ...
        # "Force Deluxe"-Schalter DIREKT unter der Solver-Auswahl ('Deluxe
        # SOFORT': Gold-/Deluxe-Box frueh aufs leere Brett, max 1x pro Brett).
        # Eigene ?-Hilfe; nur wirksam bei 'KI optimiert' + vorhandener Deluxe-Box
        # (sonst Standard-Verhalten). Reicht den Toggle ueber
        # _on_force_deluxe_toggle in die Config; waehrend des Laufs gesperrt
        # (sync_controls).
    ...
    def _build_console_view(self, _parent):
        ...
        # (v1.6.1) Test-Fenster-Buttons ENTFERNT: Das Tool laeuft direkt live an
        # echte Nutzer -- keine Test-/Trockenlauf-Buttons in der Produktions-UI.
        # (open_test_window/open_inventory_test_window in interface/testwindow.py
        # bleiben als Modul bestehen, sind aber aus der UI nicht mehr erreichbar.)
